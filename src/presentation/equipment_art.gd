...
const ART_MAPS := {
	"treadmill": [
		...
		"..3O113331313311113313313333O3..",
		"..3O333131331131133311333333O3..",
		"..3O31311MM3113313111333133MO3..",
		"..3O3313331131113M1313113113O3..",
		"..3O3311131131M33133M1333113O3..",
		"..3O331313M33131133331311M31O3..",
		"..3O131311333313331333113111O3..",
		"..3O33311111M31111311111333MO3..",
		# 返工3 P1（任务 3/4 跑带踏痕）：跑带中段加 S 踏痕 —— 使用频繁区
		# 磨暗（BELT_SCUFF 同族 EQUIP_SHADOW_TONE），跑带读作「使用中」。
		"..3OM2SS21M2M2MM212S2M2MM2M2O3..",
		"..3O1S11111SS1111111S1111SSS1O3..",
...
const FACE_MAPS := {
	"treadmill": {
		"front": [
			...
			"..33O1M2M1M2M2M1M2M1M2M2M1MO33..",
			"..33O12M2M1M2M1M2M2M1M2M1M2O33..",
			"..33O1111111111111111111111O33..",
