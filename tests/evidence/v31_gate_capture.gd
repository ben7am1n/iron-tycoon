# tests/evidence/v31_gate_capture.gd — V3.1 门禁最终渲染帧捕获（全场景 + 设备特写）
#
# 渲染真实主场景（src/main.tscn，V3.1 P1 oblique + P2 设备 + P3 手绘密度 +
# P4 pixel lighting + P5 高饱和焦点全链路）并保存两张视口快照：
#   - tests/evidence/v31-gate-final.png    全场景（根 viewport 1280×720）
#   - tests/evidence/v31-gate-closeup.png  设备带放大特写（WorldRoot scale 2x 聚焦
...
#   godot --path . res://tests/evidence/v31_gate_capture.tscn
extends Node

const MAIN_SCENE := preload("res://src/main.tscn")
const Palette := preload("res://src/palette.gd")
const WorldLayout := preload("res://src/presentation/world_layout.gd")
const OUT_FULL := "res://tests/evidence/v31-gate-final.png"
const OUT_CLOSEUP := "res://tests/evidence/v31-gate-closeup.png"
