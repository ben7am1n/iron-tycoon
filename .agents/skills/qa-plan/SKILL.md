...
user-invocable: true
---
<!-- Generated from .claude/skills/qa-plan/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
**Argument:** `invocation arguments` (blank = ask user via structured user-question capability)
...
- **No argument** — use structured user-question capability:
...
then ask two questions together using structured user-question capability:
...
- Use structured user-question capability for scope selection when no argument is provided.
