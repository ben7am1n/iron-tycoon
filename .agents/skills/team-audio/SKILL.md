...
user-invocable: true
---
<!-- Generated from .claude/skills/team-audio/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
> Usage: `/team-audio [feature or area]` — specify the feature or area to design audio for (e.g., `combat`, `main menu`, `forest biome`, `boss encounter`). Do not use structured user-question capability here; output the guidance directly.
