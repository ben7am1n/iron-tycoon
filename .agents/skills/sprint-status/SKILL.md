...
user-invocable: true
---
<!-- Generated from .claude/skills/sprint-status/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
**Argument:** `invocation argument 0` (blank = use current sprint)
