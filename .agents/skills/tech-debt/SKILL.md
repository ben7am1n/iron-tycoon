...
user-invocable: true
---
<!-- Generated from .claude/skills/tech-debt/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
Then use structured user-question capability to collect the **category**:
...
Then use structured user-question capability to collect the **estimated fix effort**:
