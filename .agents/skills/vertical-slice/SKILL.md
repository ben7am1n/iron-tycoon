...
user-invocable: true
---
<!-- Generated from .claude/skills/vertical-slice/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
- `full` → spawn `creative-director` via native subagent or delegation capability using gate **CD-PLAYTEST**
