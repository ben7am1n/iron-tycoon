...
user-invocable: true
---
<!-- Generated from .claude/skills/content-audit/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
- Preferred stable role: producer; use native delegation or role loading.
