...
user-invocable: true
---
<!-- Generated from .claude/skills/milestone-review/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
Before generating the Go/No-Go recommendation, spawn `producer` via native subagent or delegation capability using gate **PR-MILESTONE** (`.claude/docs/director-gates.md`).
...
If OFF TRACK, use structured user-question capability before generating the recommendation:
...
If AT RISK, use structured user-question capability:
