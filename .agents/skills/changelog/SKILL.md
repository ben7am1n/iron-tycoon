...
user-invocable: true
---
<!-- Generated from .claude/skills/changelog/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
- Allowed capability classes: read files, discover files, search text, run shell commands, modify files.
- Requested quality tier: fast; reasoning effort: low.
