...
user-invocable: true
---
<!-- Generated from .claude/skills/scope-check/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
**Argument:** `invocation argument 0` — feature name, sprint number, or milestone name.
