...
user-invocable: true
---
<!-- Generated from .claude/skills/team-ui/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
Then use structured user-question capability with options:
