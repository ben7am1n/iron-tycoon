...
user-invocable: true
---
<!-- Generated from .claude/skills/balance-check/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
- Preferred stable role: economy-designer; use native delegation or role loading.


## Phase 1: Identify Balance Domain

Determine the balance domain from `invocation argument 0`:
...
After presenting the report, use structured user-question capability:
