...
user-invocable: true
---
<!-- Generated from .claude/skills/perf-profile/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
- Allowed capability classes: read files, discover files, search text, run shell commands.
- Requested quality tier: balanced; reasoning effort: medium.
- Preferred stable role: performance-analyst; use native delegation or role loading.
