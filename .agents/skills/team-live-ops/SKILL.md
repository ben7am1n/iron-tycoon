...
user-invocable: true
---
<!-- Generated from .claude/skills/team-live-ops/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
delegated to sub-agents spawned via native subagent or delegation capability. Each sub-agent enforces the
