...
user-invocable: true
---
<!-- Generated from .claude/skills/playtest-report/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
After categorising findings, spawn `creative-director` via native subagent or delegation capability using gate **CD-PLAYTEST** (`.claude/docs/director-gates.md`).
