...
user-invocable: true
---
<!-- Generated from .claude/skills/quick-design/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
Present the inferred classification using structured user-question capability:
...
Present the draft to the user in full. Then use structured user-question capability:
