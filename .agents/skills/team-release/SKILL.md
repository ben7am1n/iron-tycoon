...
user-invocable: true
---
<!-- Generated from .claude/skills/team-release/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
2. If a version is found: report "No version argument provided — inferred [version] from milestone data. Proceeding." Then confirm with structured user-question capability: "Releasing [version]. Is this correct?"
3. If no version is discoverable: use structured user-question capability to ask "What version number should be released? (e.g., v1.0.0)" and wait for user input before proceeding. Do NOT default to a hardcoded version string.
