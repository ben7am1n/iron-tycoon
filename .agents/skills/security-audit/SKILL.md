...
user-invocable: true
---
<!-- Generated from .claude/skills/security-audit/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
- Allowed capability classes: read files, discover files, search text, run shell commands, modify files, delegate work.
- Requested quality tier: balanced; reasoning effort: medium.
- Preferred stable role: security-engineer; use native delegation or role loading.
...
Spawn `security-engineer` via native subagent or delegation capability. Pass:
