...
user-invocable: true
---
<!-- Generated from .claude/skills/team-narrative/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
> Usage: `/team-narrative [narrative content description]` — describe the story content, scene, or narrative area to work on (e.g., `boss encounter cutscene`, `faction intro dialogue`, `tutorial narrative`). Do not use structured user-question capability here; output the guidance directly.
...
sub-agents spawned via native subagent or delegation capability. Each sub-agent enforces the "May I write to [path]?"
