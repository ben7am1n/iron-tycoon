...
user-invocable: true
---
<!-- Generated from .claude/skills/patch-notes/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
- Preferred stable role: community-manager; use native delegation or role loading.
