...
user-invocable: true
---
<!-- Generated from .claude/skills/consistency-check/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
Then close with an structured user-question capability widget:
