...
user-invocable: true
---
<!-- Generated from .claude/skills/create-epics/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
After all epics for the current layer are defined (Step 4 completed for all in-scope systems), and before writing any files, spawn `producer` via native subagent or delegation capability using gate **PR-EPIC** (`.claude/docs/director-gates.md`).
