...
user-invocable: true
---
<!-- Generated from .claude/skills/team-polish/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
> Usage: `/team-polish [feature or area]` — specify the feature or area to polish (e.g., `combat`, `main menu`, `inventory system`, `level-1`). Do not use structured user-question capability here; output the guidance directly.
