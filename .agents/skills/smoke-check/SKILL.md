...
user-invocable: true
---
<!-- Generated from .claude/skills/smoke-check/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
- Allowed capability classes: read files, discover files, search text, run shell commands, modify files, ask structured questions.
...
Use structured user-question capability to batch-verify. Keep to at most 3 calls.
...
- Use structured user-question capability for all manual smoke check verification.
