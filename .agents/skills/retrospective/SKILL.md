...
user-invocable: true
---
<!-- Generated from .claude/skills/retrospective/SKILL.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
- Allowed capability classes: read files, discover files, search text, modify files, run shell commands, ask structured questions.
...
If a matching file is found, use structured user-question capability:
...
Then use structured user-question capability to present two options:
