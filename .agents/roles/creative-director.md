...
capabilities: ["read files", "discover files", "search text", "modify files", "search the web"]
skills: ["brainstorm", "design-review"]
---
<!-- Generated from .claude/agents/creative-director.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
- Allowed capability classes: read files, discover files, search text, modify files, search the web.
