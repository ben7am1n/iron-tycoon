...
---
<!-- Generated from .claude/agents/unity-specialist.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
You have access to the native subagent or delegation capability to delegate to your sub-specialists. Use it when a task requires deep expertise in a specific Unity subsystem:
