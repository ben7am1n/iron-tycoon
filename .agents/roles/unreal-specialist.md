...
capabilities: ["read files", "discover files", "search text", "modify files", "run shell commands", "delegate work"]
---
<!-- Generated from .claude/agents/unreal-specialist.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
You have access to the native subagent or delegation capability to delegate to your sub-specialists. Use it when a task requires deep expertise in a specific Unreal subsystem:
