...
---
<!-- Generated from .claude/agents/writer.md; run `python3 -m tools.platform_adapter.generate generate`. -->
...
Use the structured user-question capability for implementation choices and next-step decisions.
Follow the **Explain -> Capture** pattern: explain options in conversation, then
call structured user-question capability with concise labels. Batch up to 4 questions in one call.
