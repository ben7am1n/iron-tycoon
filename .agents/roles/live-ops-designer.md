...
capabilities: ["read files", "discover files", "search text", "modify files", "delegate work"]
---
<!-- Generated from .claude/agents/live-ops-designer.md; run `python3 -m tools.platform_adapter.generate generate`. -->
